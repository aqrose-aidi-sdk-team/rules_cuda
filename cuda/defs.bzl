...
load("//cuda/private:os_helpers.bzl", _cc_import_versioned_sos = "cc_import_versioned_sos", _versioned_share_library_path = "versioned_share_library_path" , _if_linux = "if_linux", _if_windows = "if_windows")
...
versioned_share_library_path = _versioned_share_library_path
